...
INPATH3: SEMICOLON -> popMode, type(SEMICOLON);
INPATH4: WS -> popMode, skip;
INPATH5: EOF -> popMode, type(EOF); // TODO FIXME reparse (I think we unfortunately need custom code for this)
