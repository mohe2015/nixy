public class MainClosure_old implements NixObject {
	...
	public static void main(String[] args) {
		System.out.println(new MainClosure_old().call(NixInteger.create(2)));
		System.out.println(new MainClosure_old().call(NixInteger.create(2)).force());
	}
}
